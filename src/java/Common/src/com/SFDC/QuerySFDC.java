...
public class QuerySFDC {
    ...
    public HashMap<String,Object>[] executeQuery(String query) throws ResilientException {
	    ...
	    try {
	    	...
	    	throw new ResilientException(ex.getMessage());
	    }  
	...
	public String insertRecords(HashMap<String,Object>[] fields) throws ResilientException{
	    ...
	    HashMap<String,Object>[] IDs = null;
            ...
            try {
                    ...
                    for(SaveResult s : sr){
                            if(!s.isSuccess()){
                                    LOGGER.error("Failed to insert records into sfdc" + s.getErrors()[0].getMessage());
                            }
                            else{
                                    retId = s.getId();
                            }
