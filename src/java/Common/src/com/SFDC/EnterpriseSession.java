...
public class EnterpriseSession {
     ...
     */
    public boolean connect(String sessionId, String serverURL, AppConfig appConfig) throws ResilientException {
            this.appConfig = appConfig;
            return login(sessionId, serverURL);
    }
     ...
     * @throws ResilientException 
     */
    private boolean login(String sessionId, String serverURL) throws ResilientException {
        ...
        try {
            ...
            binding = new SoapBindingStub(); //new SforceServiceLocator().getSoap(new URL(""));
